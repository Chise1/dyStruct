...
type (
	...
	DynamicStruct interface {
		...
		ZeroMapOfStructs(key interface{}) interface{}
	}
...
func (ds *dynamicStructImpl) ZeroMapOfStructs(key interface{}) interface{} {
	return reflect.Zero(reflect.MapOf(reflect.Indirect(reflect.ValueOf(key)).Type(), ds.definition)).Interface()
}
